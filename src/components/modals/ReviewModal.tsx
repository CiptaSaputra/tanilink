      ...
      {preOrderId && (
        ...
        >
          ...
          >
            ...
            <p className="text-[11px] text-nat-sage mb-4">Beri penilaian setelah transaksi selesai.</p>
            <div className="space-y-4">
              <div className="flex items-center justify-center gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <Star className="w-6 h-6" fill={star <= reviewRating ? '#A67C52' : 'none'} />
                  </button>
                ))}
              </div>
              <div>
                <label className="block text-xs font-bold text-nat-text mb-1">Komentar</label>
                <textarea
                  value={reviewComment}
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => {
                    addReview(preOrderId, reviewerUserId, revieweeUserId, reviewRating, reviewComment || undefined);
                    setReviewRating(5);
                    setReviewComment('');
                    onClose();
                  }}
