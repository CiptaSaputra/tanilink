        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-3 bg-white border border-nat-border rounded-2xl p-5 shadow-sm space-y-4">
              ...
              <div className="relative w-full aspect-[21/10] bg-slate-50/50 rounded-2xl p-4 border border-slate-100 shadow-sm overflow-visible">
                {(() => {
                  const points = activeForecast.forecasts;
                  const xStart = 65;
                  const xEnd = 485;
                    ...
                    <>
                      ...
                      >
                        ...
                        {[0, 0.25, 0.5, 0.75, 1].map((ratio) => {
                          ...
                          const tickVal = Math.round(ratio * maxForecastVal);
                          return (
                            <g key={ratio} className="opacity-90">
                              <line
                                x1={xStart}
                                y1={yVal}
                                x2={xEnd}
                        ...
                        {/* Vertical guidelines when hovered */}
                        {hoveredIdx !== null && (
                          <line
                            x1={xStart + hoveredIdx * (chartWidth / 3)}
                            y1={yStart}
                            x2={xStart + hoveredIdx * (chartWidth / 3)}
                            y2={yEnd}
                            stroke="#94a3b8"
                            strokeWidth="1"
                            strokeDasharray="4,4"
                            ...
                            <g key={idx}>
                              {isHovered && (
                                <circle
                                  ...
                                  cy={y}
                                  r="9"
                                  fill={COMMODITY_LIST[forecastCommodity].color}
                                  fillOpacity="0.25"
                        ...
                        {/* Transparent interactive rect overlay for smooth hover zones */}
                        {points.map((p, idx) => {
