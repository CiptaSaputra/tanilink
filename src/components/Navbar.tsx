...
import { Sprout, ShoppingBag, ShieldAlert, Sliders, RefreshCw, Layers, Lock, Users } from 'lucide-react';
...
export default function Navbar() {
  ...
  const rolesList: { id: Role; label: string; icon: React.ReactNode; color: string; desc: string }[] = [
    ...
    },
    {
      ...
      desc: 'Penyuluh Pertanian Lapangan: input data proxy petani binaan, pantau wilayah.',
    },
    {
      id: 'DINAS',
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-nat-dark tracking-tight leading-none">
                Sistem <span className="font-normal text-nat-sage">Pengurangan Food Loss</span>
              </h1>
