...
export const COMMODITY_WEIGHTS: Record<Komoditas, MatchWeights> = {
  ...
  "Bawang Merah": { wLocation: 0.45, wVolume: 0.25, wPrice: 0.3 },
  ...
  Kubis: { wLocation: 0.35, wVolume: 0.3, wPrice: 0.35 },
  Padi: { wLocation: 0.2, wVolume: 0.4, wPrice: 0.4 }, // tahan lama → volume & harga
  Jagung: { wLocation: 0.25, wVolume: 0.35, wPrice: 0.4 },
};
